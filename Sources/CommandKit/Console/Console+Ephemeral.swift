...
extension Console {
    ...
    private var depth: Int {
        get {
            return extend.get(\Console.depth, default: 0)
        }
        set {
            extend.set(\Console.depth, to: newValue)
        }
    }
    ...
    private var levels: [Int: Int] {
        get {
            return extend.get(\Console.levels, default: [:])
        }
        set {
            extend.set(\Console.levels, to: newValue)
        }
    }
}
